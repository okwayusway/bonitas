...
<!-- Modal for reserve -->
  ...
  <div class="modal fade" id="dineIn-container" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body d-flex justify-content-center">
            <form action="" class="date-time">
              ...
              <div class="time-button">
                <div class="radio-1">
                  <input type="radio" name="rDo" value="8:00am - 10:00am">
                  <label for="time1">8:00am - 10:00am</label>
                </div>
                <div class="radio-2">
                  <input type="radio" name="rDo" value="10:15am - 12:00pm">
                  <label for="time2">10:15am - 12:00pm</label>
                </div>
                <div class="radio-3">
                  <input type="radio" name="rDo" value="12:15am - 2:00pm">
                  <label for="time3">12:15am - 2:00pm</label>
                </div>
                <div class="radio-4">
                  <input type="radio" name="rDo" value="2:15pm - 4:00pm">
                  <label for="time4">2:15pm - 4:00pm</label>
                </div>
                <div class="radio-5">
                  <input type="radio" name="rDo" value="4:15pm - 6:00pm">
                  <label for="time5">4:15pm - 6:00pm</label>
                </div>
              </div>
              <div class="num-people">
                <h3 class="numPerson-text">Number of person:</h3>
                <input type="number" name="date" id="number-guest">
              </div>
            </form>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-success" id="btn_proceed">Okay</button>
  ...
  <div class="modal fade" id="event-details" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body d-flex justify-content-center">
            <div class="date-container">
              <div class="date-info">
                ...
                <div class="date-con">
                  <h3 class="date-text" id="r_date"></h3>
                </div>
              </div>
            </div>
            <div class="time-container">
              <div class="time-info">
                ...
                <div class="time-con">
                  <h3 class="time-text" id="r_time"></h3>
                </div>
              </div>
            </div>
            <div class="numOf-person">
              <div class="person-info">
                ...
                <div class="person-con">
                  <h3 class="person-text" id="r_guest"></h3>
                </div>
              </div>
            </div>
        </div>
